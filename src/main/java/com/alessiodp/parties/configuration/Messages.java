...
public class Messages {
	...
	public void loadDefaults() {
		...
		password_changed = "&aChanged password of the party";
		password_removed = "&aRemoved password of the party";
		password_broadcast = "%player% changed password of the party";
		...
		join_joined = "&aYou joined in the party %party%";
		join_playerjoined = "&b&l%player% joined in the party";
		...
		accept_alreadyinparty = "&cYou already in a party!";
		...
		leave_disbanded = "&b&lThe party has been disbanded because leader left";
		...
		members_content.add("&b&lList members of the party %party%");
		...
		rank_promoted = "&b&l%player% now is %rank%";
		rank_nomember = "&c%player% is not in your party";
		rank_noparty = "&c%player% don't have a party";
		rank_alreadyrank = "&c%player% is already a %rank%!";
		...
		home_noexist = "&cThe party doesn't exist";
		...
		vault_confirm_anycmd = "&cAny command to confirm";
		vault_confirm_warnonbuy = "&aCommand '%cmd%' cost %price%$.\nType &7/party confirm&a to use it.";
		vault_confirm_confirmed = "&aPerforming command.";
		...
		help_password = "&b/party password <password> &7- Change password of the party";
