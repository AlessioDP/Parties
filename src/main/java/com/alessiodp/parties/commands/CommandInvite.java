...
public class CommandInvite implements CommandInterface{
	...
	public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
		...
		ThePlayer invitedTp = plugin.getPlayerHandler().getThePlayer(invitedPlayer);
		if (invitedTp.haveParty()) {
		...
		LogHandler.log(2, p.getName() + "[" + p.getUniqueId() + "] invited in the party " + party.getName() + " the player " + invitedTp.getName() + "["+invitedTp.getUUID()+"]");
		return true;
	}
}
