...
public class ConfigHandler {
	...
	public void reloadConfig() {
		...
		if (cfg.get("functions.commands-per-page") != null)
			variables.commandsperpage = cfg.getInt("functions.commands-per-page");
		if (cfg.get("functions.command-tab") != null)
			variables.commandtab = cfg.getBoolean("functions.command-tab");
		...
		if (cfg.get("party.rename-cooldown") != null)
			variables.party_renamecooldown = cfg.getInt("party.rename-cooldown");
		...
		if (cfg.get("party.teleport.enable") != null)
			variables.teleport_enable = cfg.getBoolean("party.teleport.enable");
		if (cfg.get("party.teleport.delay") != null)
			variables.teleport_delay = cfg.getInt("party.teleport.delay");
		...
		if (cfg.get("chat.chat-format") != null)
			variables.chat_chatformat = cfg.getString("chat.chat-format");
		if (cfg.get("chat.allow-colors") != null)
			variables.chat_allowcolors = cfg.getBoolean("chat.allow-colors");
		if (cfg.get("chat.chat-cooldown") != null)
			variables.chat_chatcooldown = cfg.getInt("chat.chat-cooldown");
		if (cfg.get("chat.spy-chat-format") != null)
			variables.chat_spychatformat = cfg.getString("chat.spy-chat-format");
		if (cfg.get("chat.party-broadcast-format") != null)
			variables.chat_partybroadcastformat = cfg.getString("chat.party-broadcast-format");
		if (cfg.get("chat.format-group") != null)
			variables.chat_formatgroup = cfg.getString("chat.format-group");
		...
		if (cfg.get("exp.share-if-more-than") != null)
			variables.exp_sharemorethan = cfg.getInt("exp.share-if-more-than");
		if (cfg.get("exp.formula") != null)
			variables.exp_formula = cfg.getString("exp.formula");
		...
		/*if (cfg.get("exp.mythicmobs.enable") != null)
			variables.exp_mythicmobs_enable = cfg.getBoolean("exp.mythicmobs.enable");
		if (cfg.get("exp.mythicmobs.normal-exp") != null)
			variables.exp_mythicmobs_normalexp = cfg.getBoolean("exp.mythicmobs.normal-exp");
		if (cfg.get("exp.mythicmobs.skillapi-exp") != null)
			variables.exp_mythicmobs_skillapiexp = cfg.getBoolean("exp.mythicmobs.skillapi-exp");*/
		...
		if (cfg.get("vault.price-commands.create") != null)
			variables.vault_command_create_price = cfg.getDouble("vault.price-commands.create");
		if (cfg.get("vault.price-commands.join") != null)
			variables.vault_command_join_price = cfg.getDouble("vault.price-commands.join");
		if (cfg.get("vault.price-commands.home") != null)
			variables.vault_command_home_price = cfg.getDouble("vault.price-commands.home");
		if (cfg.get("vault.price-commands.set-home") != null)
			variables.vault_command_sethome_price = cfg.getDouble("vault.price-commands.set-home");
		...
		if (cfg.get("vault.price-commands.suffix") != null)
			variables.vault_command_suffix_price = cfg.getDouble("vault.price-commands.suffix");
		if (cfg.get("vault.price-commands.teleport") != null)
			variables.vault_command_teleport_price = cfg.getDouble("vault.price-commands.teleport");
		if (cfg.get("vault.price-commands.claim") != null)
			variables.vault_command_claim_price = cfg.getDouble("vault.price-commands.claim");
		...
		if (cfg.get("commands.command-teleport") != null)
			variables.command_teleport = cfg.getString("commands.command-teleport");
	...
	public void reloadMessages() {
		...
		if (msg.get("update-available") != null)
			messages.updateavailable = msg.getString("update-available");
		...
		if (msg.get("server-join") != null)
			messages.serverjoin = msg.getString("server-join");
		if (msg.get("server-leave") != null)
			messages.serverleave = msg.getString("server-leave");

		if (msg.get("p.cooldown") != null)
			messages.p_cooldown = msg.getString("p.cooldown");
		...
		if (msg.get("rename.wrong-command-admin") != null)
			messages.rename_wrongcmd_admin = msg.getString("rename.wrong-command-admin");
		...
		if (msg.get("sethome.set-broadcast") != null)
			messages.sethome_set = msg.getString("sethome.set-broadcast");
		...
		if (msg.get("home.wrong-command-admin") != null)
			messages.home_wrongcmd_admin = msg.getString("home.wrong-command-admin");
		
		if (msg.get("teleport.teleporting") != null)
			messages.teleport_teleporting = msg.getString("teleport.teleporting");
		if (msg.get("teleport.player-teleported") != null)
			messages.teleport_playerteleported = msg.getString("teleport.player-teleported");
		if (msg.get("teleport.delay") != null)
			messages.teleport_delay = msg.getString("teleport.delay");
		if (msg.get("teleport.wrong-command") != null)
			messages.teleport_wrongcmd = msg.getString("teleport.wrong-command");
		...
		if (msg.get("vault.join-nomoney") != null)
			messages.vault_join_nomoney = msg.getString("vault.join-nomoney");
		...
		if (msg.get("vault.teleport-nomoney") != null)
			messages.vault_teleport_nomoney = msg.getString("vault.teleport-nomoney");
		if (msg.get("vault.claim-nomoney") != null)
			messages.vault_claim_nomoney = msg.getString("vault.claim-nomoney");
		...
		if (msg.get("help.teleport") != null)
			messages.help_teleport = msg.getString("help.teleport");
		...
		if (msg.get("help.rename-others") != null)
			messages.help_rename_others = msg.getString("help.rename-others");
