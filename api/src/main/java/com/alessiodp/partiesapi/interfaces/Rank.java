...
public interface Rank {
	...
	/**
	 * Set the permissions list of the rank
	 * 
	 * @param perm
	 *            The permissions list of the rank
	 */
	void setPermissions(List<String> perm);
	
	/**
	 * Get the permissions list of the rank
	 * 
	 * @return Returns the permissions list of the rank
	 */
