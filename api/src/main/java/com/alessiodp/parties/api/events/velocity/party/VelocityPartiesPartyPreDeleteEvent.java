...
public class VelocityPartiesPartyPreDeleteEvent extends VelocityPartiesEvent implements IPartyPreDeleteEvent {
	...
	public VelocityPartiesPartyPreDeleteEvent(Party party, DeleteCause cause, PartyPlayer kickedPlayer, PartyPlayer commandSender) {
		this.party = party;
		this.cause = cause;
