...
public interface Rank {
	 ...
	 * 
	 * @param hardname
	 *            The configuration name of the rank
	 */
	 ...
	 * 
	 * @param def
	 *            {@code True} to set the rank as the default
	 */
	...
	/**
	 * Set the permissions executors of the rank
	 * 
	 * @param perm
	 *            The permissions executors of the rank
	 */
	void setPermissions(List<String> perm);
	
	/**
	 * Get the permissions executors of the rank
	 * 
	 * @return Returns the permissions executors of the rank
	 */
