...
import com.alessiodp.parties.velocity.messaging.redis.VelocityPartiesRedisBungeeListener;
...
public class VelocityPartiesMessageListener extends VelocityMessageListener {
	public VelocityPartiesMessageListener(@NotNull ADPPlugin plugin) {
		super(
				plugin,
				new VelocityPartiesBungeecordListener(plugin),
				new VelocityPartiesRedisBungeeListener(plugin)
		);
	}
}
